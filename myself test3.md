...
* 复制 URL
* 在 Markdown 中使用完整 URL
* 引用操作的语法：![替代文本](图片链接url)就是最上头的操作，弊端就是如果图片名字改了或怎么样，之前那个链接就打不开了，失效

#### 方法二
相对引用
* ![超链接语法结构截图]（images/chao lian jie 语法结构.png）
* ![超链接语法结构截图](Images/chao-lian-jie.png)这里终于相对引用图片成功了，就是图片命名的时候不要有空格，我加了小横线之后就可以了，上边的那个一直不成功
* 引用语法操作：![描述](images/图片名.png)
* 注意：这里的images是指你仓库内放图片的文件夹名称，而/是代表文件夹的关键
